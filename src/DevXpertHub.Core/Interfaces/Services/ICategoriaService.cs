...
public interface ICategoriaService
{
    ...
    Task<CategoriaDto> AdicionarAsync(CategoriaCreateDto categoriaDto);
    ...
    /// <summary>
    /// Obtém todas as categorias com produtos associados de forma assíncrona.
    /// </summary>
    /// <returns>Uma tarefa que representa a operação assíncrona. O resultado da tarefa
    /// contém uma lista de DTOs representando todas as categorias que possuem produtos associados.</returns>
    Task<IEnumerable<CategoriaDto>> ObterCategoriasComProdutosAsync();
    ...
    Task<CategoriaDto> ObterPorIdAsync(string id);
    ...
    Task<CategoriaDto> AtualizarAsync(CategoriaUpdateDto categoriaDto);
