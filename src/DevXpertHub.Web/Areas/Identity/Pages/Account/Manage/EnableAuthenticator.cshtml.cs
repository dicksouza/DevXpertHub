...
namespace DevXpertHub.Web.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("O usuário com o ID '{UserId}' habilitou 2FA com um aplicativo autenticador.", userId);
        ...
        {
            // Carrega a chave do autenticador e o URI do QR code para exibir no formulário
